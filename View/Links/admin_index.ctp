        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header with-border">
                    <h3 class="card-title"><?= $Lang->get('LINKS__ADD') ?> &nbsp;&nbsp;<a href="<?= $this->Html->url(array('controller' => 'links', 'action' => 'add', 'admin' => true)) ?>" class="btn btn-success"><?= $Lang->get('GLOBAL__ADD') ?></a></h3>
                </div>
                <div class="card-body">
